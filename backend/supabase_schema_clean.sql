-- ================================================================================
-- 🟢 Klaro Educational Platform - Clean Supabase Schema
-- ================================================================================
-- This schema safely creates all required tables for the Klaro platform
-- Safe to run multiple times - handles all edge cases and duplicates
-- ================================================================================
...
DROP TRIGGER IF EXISTS update_quiz_history_updated_at ON quiz_history;
DROP TRIGGER IF EXISTS update_jee_test_results_updated_at ON jee_test_results;
...
-- Drop all indexes (they'll be recreated with tables)
DROP INDEX IF EXISTS idx_doubts_user_id;
DROP INDEX IF EXISTS idx_doubts_created_at;
DROP INDEX IF EXISTS idx_doubts_subject;
DROP INDEX IF EXISTS idx_quiz_history_user_id;
DROP INDEX IF EXISTS idx_quiz_history_created_at;
DROP INDEX IF EXISTS idx_jee_results_user_id;
DROP INDEX IF EXISTS idx_jee_results_created_at;
DROP INDEX IF EXISTS idx_jee_results_test_type;
DROP INDEX IF EXISTS idx_analytics_user_id;
DROP INDEX IF EXISTS idx_analytics_created_at;
DROP INDEX IF EXISTS idx_analytics_route;
...
DROP INDEX IF EXISTS idx_progress_feature;
...
DROP TABLE IF EXISTS jee_test_results CASCADE;
...
-- ================================================================================
-- 📚 Subjects Table (Create First - Referenced by Other Tables)
-- ================================================================================
...
-- Apply triggers only to tables with updated_at columns
...
COMMENT ON SCHEMA public IS 'Klaro Educational Platform - Clean Schema v2.0';
